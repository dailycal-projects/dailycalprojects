...
const MyMap = () => {
  ...
  return (
    <div>
      ...
      >
        <h4>
          Change in enrollment of Black students between the 1990-91 and 2020-21
          academic years
        </h4>
      </div>
      {typeof window !== "undefined" ? ( // must condition inside of a div in case content is null
        <MapContainer
          ...
          bounds={[
            [
              districtData.minLat - bufferLat,
              districtData.minLong - bufferLong,
            ],
            [
              districtData.maxLat + bufferLat,
              districtData.maxLong + bufferLong,
            ],
          ]}
        >
