  ...
  return (
    <Timeline position="alternate">
      <TimelineItem>
        ...
        <TimelineContent>
          <br />
          <img src={Age4} alt="Kira Kutcher at age 4" />
          <br />
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <br />
          <img src={Age6} alt="Kira Kutcher at age 6" />
          <br />
          Kira Kutcher | Courtesy
          <br />
          <br />
      ...
      <TimelineItem>
        <TimelineOppositeContent color="text.secondary">
          ...
          <br />A long-time figure skater, Kutcher has been attracted to flowy
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <br />
          <img src={CollegeClass} alt="Kira Kutcher gets ready for class" />
          <br />
          Kira Kutcher | Courtesy
          <br />
          <br />
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <br />
          <img src={BladeRave} alt="Kira Kutcher attending Blade Rave" />
          <br />
          Kira Kutcher | Courtesy
          <br />
          <br />
