        ...
        <ResponsiveContainer height={500}>
          ...
          >
            ...
            <Area
              type="monotone"
              dataKey="Football"
              stroke={colors.football}
              fillOpacity={1}
              fill="url(#football)"
            />
            <Area
              type="monotone"
              dataKey="Men's basketball"
              stroke={colors.mbasket}
              fillOpacity={1}
              fill="url(#mensBasketball)"
            />
            <Area
              type="monotone"
              dataKey="Women's basketball"
              stroke={colors.wbasket}
              fillOpacity={1}
              fill="url(#womensBasketball)"
            />
            <Area
              type="monotone"
              dataKey="Other men's sports"
              stroke={colors.msports}
              fillOpacity={1}
              fill="url(#otherMens)"
            />
            <Area
              type="monotone"
              dataKey="Other women's sports"
              stroke={colors.wsports}
              fillOpacity={1}
              fill="url(#otherWomens)"
            />
            <Area
              type="monotone"
              dataKey="Non-program specific"
              stroke={colors.np}
              fillOpacity={1}
              fill="url(#nonprogram)"
            />
