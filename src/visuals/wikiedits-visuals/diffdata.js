const diffs = {
  yudof: {
    ...
    legend_delete: true,
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=prev&oldid=520039488",
    name: "Mark Yudof",
...
3.1415926535...`,
    ...
    article:
      "https://en.wikipedia.org/w/index.php?title=History_of_Estonia&diff=prev&oldid=128149041",
    time: "May 3rd, 2007",
  },
...
==References==`,
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=prev&oldid=316075494",
...
- /|nt|\/1ru$ -`,
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=next&oldid=316707479",
  ...
  kline_timebest: {
    ...
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=329920206&oldid=329732029",
    time: "December 4th, 2009",
  },
  ...
  kline_berkeley: {
    ...
    legend_add: true,
    old: "",
    new: `[[New York Times]] columnist [[Bob Herbert]] visited the [[UC Berkeley]] campus and had this to say: <blockquote>
“The problems at Berkeley are particularly acute because of the state’s drastic reduction of support. But colleges and universities across the country — public and private — are struggling because of the prolonged economic crisis and the pressure on state budgets. It will say a great deal about what kind of nation we’ve become if we let these most valuable assets slip into a period of decline.”
    ...
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=prev&oldid=329919987",
    time: "December 5th, 2009",
  },
...
Because of the [[California budget crisis]], in April 2009, Yudof noted the University of California's large workforce could face salary cuts. In the summer of 2009, the [[California legislature]] cut $3 billion from state colleges, universities and the University of California. The [[UC Regents]] and Yudof approved the cuts by imposing tuition increases and layoffs. As a result, on September 3, 2009, 9,600 UC staff and faculty members at all 10 campuses of the [[University of California]] signed a vote of no confidence to Yudof. Approximately 10,000 people cast a ballot, representing about 70,000 of the university's 180,000 employees, according to labor unions. A system-wide walkout on the part of students, faculty and workers occurred on September 24, 2009 to protest the cuts, faculty furloughs and tuition fee increases.`,
    ...
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=prev&oldid=329732029",
    time: "December 4th, 2009",
  },
  ...
  kliner_infobox: {
    intro: true,
    legend_delete: true,
    old: `| workplaces    = [[University of Texas School of Law]]<br>[[University of Minnesota]]<br>[[University of Texas System]]<br>[[University of California]]
...
| website       = [http://www.universityofcalifornia.edu/president/welcome.html President Mark G. Yudof]`,
    new: `| workplaces    = [[University of Texas School of Law]]<br>[[University of Minnesota]]<br>[[University of Texas System]]<br>[[University of California]]
| profession    = University administrator, professor
| spouse        = Judy Yudof
| website       = [http://www.universityofcalifornia.edu/president/welcome.html President Mark G. Yudof]`,
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=prev&oldid=316706580",
    time: "September 28th, 2009",
  },
  ...
  kliner_sixth: {
    ...
    intro: true,
    refs_hidden: true,
    old: `Yudof is a [[fellow]] of the [[American Academy of Arts and Sciences]] and a member of the [[American Law Institute]]. In 1993, he and his wife, Judy, were the co-recipients of the [[Jewish National Fund]] Tree of Life Award.  Judy Yudof became the first female international president of the [[United Synagogue of Conservative Judaism]] in 2002 and now serves as the organization's honorary president.

In 2006, Yudof was the sixth-highest paid public university chancellor in the United States, with a compensation package worth over $740,000 per year from The University of Texas. 

University of California presidential search committee chairman [[Richard C. Blum]] announced on [[March 20]], [[2008]] that Yudof had been selected for recommendation to the Board of Regents as the next president of UC to succeed [[Robert C. Dynes]]. Blum said: `,
    new: `Yudof is a [[fellow]] of the [[American Academy of Arts and Sciences]] and a member of the [[American Law Institute]]. In 1993, he and his wife, Judy, were the co-recipients of the [[Jewish National Fund]] Tree of Life Award.  Judy Yudof became the first female international president of the [[United Synagogue of Conservative Judaism]] in 2002 and now serves as the organization's honorary president.

University of California presidential search committee chairman [[Richard C. Blum]] announced on [[March 20]], [[2008]] that Yudof had been selected for recommendation to the Board of Regents as the next president of UC to succeed [[Robert C. Dynes]]. Blum said: `,
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=prev&oldid=316707479",
    time: "September 28th, 2009",
  },
  ...
  kliner_criticism: {
    legend_delete: true,
    intro: true,
    old: `In an interview for The New York Times, Yudof compares being the President of the University of California to "being a manager of a cemetery: there are many people under you, but no one is listening" When asked how he got into education Yudof replied 
...
==See Also==`,
    new: `In an interview for The New York Times, Yudof compares being the President of the University of California to "being a manager of a cemetery: there are many people under you, but no one is listening" When asked how he got into education Yudof replied 
"I don’t know. It’s all an accident. I thought I’d go work for a law firm." <ref>{{cite news | last=Solomon | first=Deborah | title=Questions for Mark Yudof - Big Man on Campus work=[[The New York Times]] | date=2009-09-24 | url=http://www.nytimes.com/2009/09/27/magazine/27fob-q4-t.html | accessdate=2009-09-24 }}</ref>

==See Also==`,
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=prev&oldid=316705476",
    time: "September 28th, 2009",
  },
  ...
  kliner_large: {
    ...
    legend_delete: true,
    refs_hidden: true,
    old: `His first-year compensation at The University of California was $828,000, of which $591,084 was salary, and $228,000 was a first-year contribution to his pension. He later told the New York Times he cut his salary to $540,000.
...
"I don’t know. It’s all an accident. I thought I’d go work for a law firm."`,
    ...
    name: "Mark Yudof",
    article:
      "https://en.wikipedia.org/w/index.php?title=Mark_Yudof&diff=prev&oldid=316707247",
    time: "September 28th, 2009",
  },
  ...
  UCOP_buffy: {
    intro: true,
    legend_add: true,
    old: `* It is in this episode that Willow and Tara's relationship takes a romantic turn; although no romantic affection is explicitly shown, it can be inferred from the quality of their interactions.
`,
    new: `* It is in this episode that Willow and Tara's relationship takes a romantic turn; although no romantic affection is explicitly shown, it can be inferred from the quality of their interactions.
* Before turning romantic, the start Willow and Tara's relationship is foreshadowed a couple of times in this episode. First, when Willow prays for the heart she desires in a poker game with Anya and Xander. Next, when Willow notes "everybody's getting spanked" but her, alluding to the fact that she is the only one without a girlfriend or boyfriend.`,
    name: "The I in Team",
    article:
      "https://en.wikipedia.org/w/index.php?title=The_I_in_Team&diff=prev&oldid=434669616",
    time: "June 16th, 2011",
  },
  ...
  UCOP_aquatic: {
    ...
    legend_delete: true,
    old: `== Park features ==
Aquatic Park features picnic areas, "Dream Land for Kids"-- a large children's playground, a pedestrian-bicycle path, and a [[disc golf]] course. The lagoon is used by the [http://www.berkeleyrowingclub.org/ Berkeley Paddling and Rowing Club] year round, and by the [http://www.berkeleywaterskiclub.com/ Berkeley Water Ski Club] during the summer months (their ski ramp is visible in the middle of the lagoon). Historically, it was also a practice site for the University of California [[College rowing (United States)| crew]] teams (see [http://www.calbears.com/sports/m-crew/cal-m-crew-body.html California Golden Bears]).

There is an Emeryville entrance on the south side of the park, which has been historically known as a place for homosexual men to meet.`,
    new: `== Park features ==
Aquatic Park features picnic areas, "Dream Land for Kids"-- a large children's playground, a pedestrian-bicycle path, and a [[disc golf]] course. The lagoon is used by the [http://www.berkeleyrowingclub.org/ Berkeley Paddling and Rowing Club] year round, and by the [http://www.berkeleywaterskiclub.com/ Berkeley Water Ski Club] during the summer months (their ski ramp is visible in the middle of the lagoon). Historically, it was also a practice site for the University of California [[College rowing (United States)| crew]] teams (see [http://www.calbears.com/sports/m-crew/cal-m-crew-body.html California Golden Bears]).
`,
    name: "Aquatic Park (Berkeley)",
    article:
      "https://en.wikipedia.org/w/index.php?title=Aquatic_Park_(Berkeley)&diff=prev&oldid=456270566",
    time: "October 18th, 2011",
  },
...
During a panel discussion at [[Harvard University]]'s reunion for African American alumni during the 2003–04 academic year, two prominent black professors at the institution—[[Lani Guinier]] and [[Henry Louis Gates]]—pointed out an unintended effect of affirmative action policies at Harvard. They stated that…`,
    ...
    article:
      "https://en.wikipedia.org/w/index.php?title=Affirmative_action_in_the_United_States&diff=prev&oldid=797054043",
    time: "August 24th, 2017",
  },

  UCOP_rector: {
    intro: true,
    legend_add: true,
    old: `On Wednesday, [[May 21]] [[1969]], a midday memorial was held for student James Rector at Sproul Plaza on the University campus. 
Rector had suffered massive internal injuries from his shotgun wounds, finally dying at [[Alta Bates Summit Medical Center|Herrick Hospital]] on [[May 19]]. In his honor, several thousand people peacefully assembled to listen to speakers remembering his life. Without warning, National Guard troops surrounded Sproul Plaza, donned their gas masks, and pointed their bayonets inward, while helicopters dropped [[CS gas]] directly on the trapped crowd. No escape was possible, and the gas caused acute respiratory distress, disorientation, temporary blindness and vomiting. Many people, including children and the elderly, were injured during the ensuing panic. The gas was so intense that breezes carried it into Cowell Memorial Hospital, endangering patients, interrupting operations and incapacitating nurses. Students at nearby Jefferson and Franklin elementary schools were also affected.`,
    new: `On Wednesday, [[May 21]] [[1969]], a midday memorial was held for student James Rector at Sproul Plaza on the University campus. 
...
Rector had suffered massive internal injuries from his shotgun wounds, finally dying at [[Alta Bates Summit Medical Center|Herrick Hospital]] on [[May 19]]. In his honor, several thousand people peacefully assembled to listen to speakers remembering his life. Without warning, National Guard troops surrounded Sproul Plaza, donned their gas masks, and pointed their bayonets inward, while helicopters dropped [[CS gas]] directly on the trapped crowd. No escape was possible, and the gas caused acute respiratory distress, disorientation, temporary blindness and vomiting. Many people, including children and the elderly, were injured during the ensuing panic. The gas was so intense that breezes carried it into Cowell Memorial Hospital, endangering patients, interrupting operations and incapacitating nurses. Students at nearby Jefferson and Franklin elementary schools were also affected.`,
    name: "People's Park (Berkeley)",
    article:
      "https://en.wikipedia.org/w/index.php?title=People%27s_Park_(Berkeley)&diff=prev&oldid=127539961",
    time: "May 1st, 2007",
  },
  ...
  UCOP_accused: {
    ...
    article:
      "https://en.wikipedia.org/w/index.php?title=Communist_Party_USA&diff=prev&oldid=422532742",
    time: "April 5th, 2011",
  },
...
`,
    name: "Rich Lyons",
    article:
      "https://en.wikipedia.org/w/index.php?title=Rich_Lyons&diff=prev&oldid=1268021051",
...
Lyons is also known for culture leadership — anchoring institutions on distinctive values that help create a cohesive community that supports the mission. As dean of the Haas School of Business, he led an initiative that codified the school's culture around four defining leadership principles: question the status quo, confidence without attitude, students always, and beyond yourself. He is a powerful advocate for public higher education that is both accessible and excellent. He also believes culture leadership connects to the “why” of great education, including not just knowledge and thinking tools, but also opportunities that enhance personal development.  `,
    ...
    name: "Rich Lyons",
    article:
      "https://en.wikipedia.org/w/index.php?title=Rich_Lyons&diff=next&oldid=1270362287",
