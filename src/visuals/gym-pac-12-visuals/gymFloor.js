  ...
  <div>
    ...
    <ResponsiveContainer height={600} width="100%">
      ...
      >
        ...
        <Legend />
        <Scatter name="UTAH" data={floorData.UTAH} fill="#df4c57" line />
        <Scatter name="CAL" data={floorData.CAL} fill="#186892" line />
        <Scatter
          name="OREGON STATE"
        ...
        <Scatter
          ...
          line
        />
        <Scatter name="ARIZONA" data={floorData.ARIZONA} fill="#274659" line />
        <Scatter
          name="ARIZONA STATE"
