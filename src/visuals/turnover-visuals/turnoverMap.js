...
const TurnoverMap = () => {
  const centerLat =
    (turnoverCoordinates.minLat + turnoverCoordinates.maxLat) / 2;
  const distanceLat = turnoverCoordinates.maxLat - turnoverCoordinates.minLat;
  const bufferLat = distanceLat * 0.05;
  const centerLong =
    (turnoverCoordinates.minLong + turnoverCoordinates.maxLong) / 2;
  const distanceLong =
    turnoverCoordinates.maxLong - turnoverCoordinates.minLong;
    ...
    <div>
      {typeof window !== "undefined" ? (
        <MapContainer
          ...
          bounds={[
            [
              turnoverCoordinates.minLat - bufferLat,
              turnoverCoordinates.minLong - bufferLong,
            ],
            [
              turnoverCoordinates.maxLat + bufferLat,
              turnoverCoordinates.maxLong + bufferLong,
            ],
          ]}
        >
