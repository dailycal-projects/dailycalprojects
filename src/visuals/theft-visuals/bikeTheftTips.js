    ...
    <ul style={{ fontSize: "1.00em", listStylePosition: "inside" }}>
      ...
      <li>
        ...
        >
          {/* Sub-bullets */}
          <li>
            For bike owners, use a solid U-lock along with a cable to secure
            both the frame and wheels of the bike.
          </li>
          <li>
            For scooter owners, use a U-lock “between the scooter stem and the
            deck” to secure the vehicle to the rack.
          </li>
        </ul>
      </li>
