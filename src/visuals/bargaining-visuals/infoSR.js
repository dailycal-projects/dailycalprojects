...
export const infoSR = {
  ...
  Childcare: {
    ...
    intro: 'On April 22, 2022, SRU-UAW proposed that the UC system reimburse SRs for child care costs up to $6000 per quarter and $9000 per semester. In response, the UC system offered maximum reimbursements of less than $6000 per year. The Dec. 16 tentative agreement guarantees $1400 per fiscal quarter starting Oct. 1, 2024.',

  },
  'Community safety': {

    proposals: communitysafetyProposals,
    intro: 'Despite past negotiations, the tentative contract agreement does not contain this article.',
  ...
  'Discipline and dismissal': {
    ...
    intro: 'Negotiations for the procedures and grounds for disciplining and dismissing SRs reached a tentative agreement.',

  },
  Duration: {

    proposals: durationProposals,
    intro: 'The contract should terminate May 31, 2025, by the tentative agreement on this new contract.',
  ...
  Leaves: {
    ...
    intro: 'The tentative agreement details eligibility for and duration of different kinds of leaves.',
  ...
  'No strikes': {
    ...
    intro: 'A tentative agreement was reached Dec. 16, prohibiting authorization of strikes by the union.',

  },
  'Parking and transit': {
    proposals: parkingTransitProposals,
    intro: 'On Nov. 30, 2022, negotiations between parties resulted in a tentative agreement on parking and transit policies.',
  ...
  Recognition: {
    ...
    intro: 'A tentative agreement reached Dec. 16 determined the groups that should be represented by the SRU-UAW. All are graduate student positions.',
  ...
  'Vacation and personal time off': {
    ...
    intro: 'By a Nov. 30, 2022 tentative agreement, SRs should receive twelve workdays of personal time off per year.',
  ...
  'Summer support fund side letter': {
    ...
    intro: 'Negotiations for this side letter are still in negotiation. The first proposal came from the UC system in December 2022.',
  },
  ...
  'UCSF side letter': {
    ...
    intro: 'The first proposal for this side letter was introduced by the UC system Dec. 4, 2022. The side letter saw a tentative agreement shortly after on Dec. 16.',

  },
  'Leaves side letter': {
    proposals: leavesSideLetter,
    intro: 'Language for this side letter on leaves was tentatively agreen upon Dec. 16.',
