...
const ASUCFunding = ({ data = asucData }) => {
  ...
  useEffect(() => {
    ...
    const validData = data
      ...
      .filter(
        (d) =>
          !isNaN(d.funding) && !isNaN(d.years_of_sponsorship) && d.funding > 0
      );
    ...
    function forceRadial() {
      ...
      return function (alpha) {
        nodes.forEach((node) => {
          ...
          if (currentRadius > 0) {
            const k =
              ((node.targetRadius - currentRadius) / currentRadius) *
              strength *
              alpha;
            node.vx += dx * k;
            node.vy += dy * k;
    ...
    const circles = clubsGroup
      ...
      .on("mouseover", (event, d) => {
        ...
        tooltip.style("opacity", 1).html(`
            ...
            Funding: $${d.funding.toLocaleString(undefined, {
  ...
  return (
    ...
    >
      <div className="container">
        ...
        >
          <img alt="" width="16" height="22.9" src={cursorIcon} />
