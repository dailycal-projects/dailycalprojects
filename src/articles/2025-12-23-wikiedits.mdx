...
<br />
The “[Communist Party USA](https://en.wikipedia.org/wiki/Communist_Party_USA)” article
was the subject of a 2011 edit by a UCOP IP address who challenged the claim that
Julius and Ethel Rosenberg, who were convicted and executed by the United States,
provided nuclear secrets to the Soviets during the Cold War.
...
<body>
  ...
  >
    ...
    Source:{" "}
    <a
      href="https://en.wikipedia.org/w/index.php?title=Special%3AContributions&target=Mgoehring&namespace=all&tagfilter=&start=&end="
      style={{ color: "#545454", fontFamily: "Georgia", fontSize: "14px" }}
    >
      User contributions for Mgoehring
    </a>
  </div>
</body>
