...
<body>
  ...
  >
    ...
    <br />
    Source:{" "}
    <a href="https://en.wikipedia.org/w/index.php?title=Mark_Yudof&action=history" style={{ color: "#707070", fontSize: "12px" }}>Revision history</a>{" "}
...
<body>
  ...
  >
    ...
    <br />
    Source:{" "}
    <a href="https://en.wikipedia.org/wiki/Talk:Mark_Yudof" style={{ color: "#707070", fontSize: "12px" }}>Talk page</a>{" "}
    of the <a href="https://en.wikipedia.org/wiki/Mark_Yudof">Mark Yudof</a>{" "}
    article on Wikipedia
  </div>
</body>
...
<body>
  <GatsbyImage image={getImage(props.localImages[4])} />
  <div
    style={{
      color: "#707070",
      fontSize: "13px",
  ...
  >
    <em>
      Edits by user Mgoehring, all of which were made to the Rich Lyons
      Wikipedia article. Edit times are displayed in UTC.
    </em>
    <br />
    Source:{" "}
    <a href="https://en.wikipedia.org/w/index.php?title=Special%3AContributions&target=Mgoehring&namespace=all&tagfilter=&start=&end=" style={{ color: "#707070", fontSize: "10px" }}>User contributions for Mgoehring</a>
  </div>
</body>

<br />

<Wikidiff diff_id="Lyons_change" />
