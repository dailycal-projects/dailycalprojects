...
For the past decade, revenue from media rights has consistently been in the eight figure dollar amount for Cal Athletics. Media rights have also consistently increased since 2015, albeit with a dip in the athletic season following the pandemic lockdown.

Despite this, revenue from media rights does not ever reach $32 million for Cal Athletics. In comparison, Big Ten schools are expected to make around $71.875 million from media rights alone until the Big Ten media contract expires in 2030, as aforementioned.
...
_Overall Cal Athletics debt vs. the debt from select divisions of Cal Athletics, adjusted for inflation to the 2024 dollar amount._
...
_Overall budget over time for the six different categories of Cal Athletics as listed in their financial statements. Overall budget was computed as the difference between revenue and expenses within that particular category. Debt was listed separately in the financial statements and is not included as an expense in this chart. All dollar amounts were adjusted for inflation to the 2024 value._
